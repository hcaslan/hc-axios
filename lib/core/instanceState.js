    ...
    if (utilities.interceptorManager) {
      try {
        if (typeof utilities.interceptorManager.getGroups === 'function') {
          interceptorManagerStats.groups = utilities.interceptorManager.getGroups().length;
        }
        if (typeof utilities.interceptorManager.getConditionalInterceptors === 'function') {
          interceptorManagerStats.conditionalInterceptors = utilities.interceptorManager.getConditionalInterceptors().length;
        }
      } catch (error) {
  ...
  instance.createSnapshot = function() {
    ...
    if (utilities.interceptorManager) {
      try {
        ...
        } else if (typeof utilities.interceptorManager.getActiveGroups === 'function') {

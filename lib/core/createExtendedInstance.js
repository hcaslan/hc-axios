...
import { responseTransformers, commonPatterns } from '../utils/responseTransform.js';
...
export function createExtendedInstance(config) {
  ...
  instance.uploadFile = function(file, options = {}) {
    return commonPatterns.uploadFile(instance, file, options);
  };
  ...
  instance.resource = function(resourcePath) {
    return commonPatterns.createResource(instance, resourcePath);
  };
  ...
  instance.healthCheck = function(endpoint) {
    return commonPatterns.createHealthCheck(instance, endpoint);
  };
  ...
  /**
   * Configure common development setup
   */
